...
action_7 (7) = happyGoto action_19
...
action_15 (10) = happyGoto action_11
...
action_18 (8) = happyGoto action_9
...
happyReduction_4 (_ `HappyStk`
	...
	_ `HappyStk`
	(HappyTerminal (Var _ happy_var_1)) `HappyStk`
	happyRest)
	 = HappyAbsSyn6
...
happyReduction_5 (HappyAbsSyn7  happy_var_3)
	_
	(HappyTerminal (Var _ happy_var_1))
	 =  HappyAbsSyn6
		 (Sass happy_var_1 happy_var_3
	)
...
happyReduction_6 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn6
		 (Swhile happy_var_2 happy_var_5
	) `HappyStk` happyRest
...
happyReduction_8 (HappyAbsSyn8  happy_var_3)
	(HappyTerminal (Sym _ happy_var_2))
	(HappyAbsSyn7  happy_var_1)
	 =  HappyAbsSyn7
		 (Aop happy_var_2 happy_var_1 happy_var_3
	)
happyReduction_8 _ _ _  = notHappyAtAll 

happyReduce_9 = happySpecReduce_1  8 happyReduction_9
happyReduction_9 (HappyTerminal (Var _ happy_var_1))
	 =  HappyAbsSyn8
...
happyNewToken action sts stk (tk:tks) =
	...
	While _ -> cont 11;
	Do _ -> cont 12;
	BracketOpen _ -> cont 13;
	BracketClose _ -> cont 14;
	ParensOpen _ -> cont 15;
	ParensClose _ -> cont 16;
	Semicolon _ -> cont 17;
	Assign _ -> cont 18;
	Sym _ happy_dollar_dollar -> cont 19;
	Var _ happy_dollar_dollar -> cont 20;
	Int _ happy_dollar_dollar -> cont 21;
	TLT _ -> cont 22;
	TGT _ -> cont 23;
	TAND _ -> cont 24;
	_ -> happyError' (tk:tks)
