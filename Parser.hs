...
happyReduction_7 (HappyTerminal (Var _ happy_var_1))
	 =  HappyAbsSyn8
...
happyNewToken action sts stk (tk:tks) =
	...
	While _ -> cont 9;
	Do _ -> cont 10;
	BracketOpen _ -> cont 11;
	BracketClose _ -> cont 12;
	ParensOpen _ -> cont 13;
	ParensClose _ -> cont 14;
	Semicolon _ -> cont 15;
	Assign _ -> cont 16;
	Sym _ happy_dollar_dollar -> cont 17;
	Var _ happy_dollar_dollar -> cont 18;
	Int _ happy_dollar_dollar -> cont 19;
	_ -> happyError' (tk:tks)
	}
